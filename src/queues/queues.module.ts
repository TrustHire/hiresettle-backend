...
export const stellarTxQueueOptions = {
  name: QUEUE_STELLAR_TX,
  defaultJobOptions: {
    attempts: 5,
    backoff: { type: "exponential", delay: 5000 },
  },
};
export const webhookQueueOptions = {
  name: QUEUE_WEBHOOK,
  defaultJobOptions: {
    attempts: 3,
    backoff: { type: "exponential", delay: 2000 },
...
export const slackQueueOptions = {
  name: QUEUE_SLACK,
  defaultJobOptions: {
    attempts: 3,
    backoff: { type: "exponential", delay: 2000 },
...
export const discordQueueOptions = {
  name: QUEUE_DISCORD,
  defaultJobOptions: {
    attempts: 3,
    backoff: { type: "exponential", delay: 2000 },
