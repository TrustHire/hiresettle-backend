...
describe('AdminAuditLogsService', () => {
  ...
  describe('queryAuditLogs', () => {
    it('should return unified audit logs from all sources', async () => {
      ...
      mockPrisma.engagementAuditLog.findMany.mockResolvedValue(mockEngagementAuditLogs);
      mockPrisma.milestoneAuditLog.findMany.mockResolvedValue(mockMilestoneAuditLogs);
    ...
    it('should filter by action', async () => {
      ...
      await service.queryAuditLogs({ action: 'STATUS_OVERRIDE', page: 1, limit: 50 });
    ...
    it('should filter by date range', async () => {
      ...
      const dateFilter = { gte: new Date('2024-01-01'), lte: new Date('2024-01-31') };
